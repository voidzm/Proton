...
/* This ChunkProvider supportes world generation up into the top 128 blocks of the world. Since the way that this works with vanilla biomes
 * is currently funky, this is being left alone for now. The code is mostly functional, though (caves and ravines are broken).
 */

public class ChunkProviderProton implements IChunkProvider {
	...
	public ChunkProviderProton(World par1World, long par2, boolean par4) {
	...
	public void generateTerrain(int par1, int par2, byte[] par3ArrayOfByte) {
		...
		byte b3 = 33;
		int l = b0 + 1;
		System.out.println("Args are " + (par1 * 4 - 2) + ", " + (par2 * 4 - 2) + ", " + (k + 5) + ", " + (l + 5) + ".");
