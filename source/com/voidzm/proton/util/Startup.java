...
public class Startup {
	...
	private static int recipesCreated = 0;
	...
	public static void recipesCreated(int number) {
		recipesCreated = number;
	}

	public static void outputCraftingStats() {
		FMLLog.info("[Proton] %d recipes added.", recipesCreated);
	}
	...
	public static void loadingDone() {
		...
		outputCraftingStats();
		outputBiomeStats();
		outputDimensionStats();
		outputTileEntityStats();
