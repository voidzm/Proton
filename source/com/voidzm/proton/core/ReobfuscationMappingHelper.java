/*******
>>> ReobfuscationMappingHelper.java <<<
>>> Proton <<<
...
public class ReobfuscationMappingHelper {
	...
	public ReobfuscationMappingHelper() {
		...
		if(!versionIdentifier.equals(Constants.minecraftversion)) {
			throw new RuntimeException("The mappings in remap.csv DO NOT match the current Minecraft version! This version of Proton is likely out of date.");
		}
